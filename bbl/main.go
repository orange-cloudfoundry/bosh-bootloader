...
func main() {
	...
	bufferingCLI := terraform.NewCLI(terraformOutputBuffer, terraformOutputBuffer, dotTerraformDir, globals.DisableTfAutoApprove)
	var (
	...
	if appConfig.Global.Debug {
		...
		terraformCLI = terraform.NewCLI(errBuffer, terraformOutputBuffer, dotTerraformDir, globals.DisableTfAutoApprove)
		out = os.Stdout
	} else {
