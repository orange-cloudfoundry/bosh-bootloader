...
import (
	...
	"github.com/orange-cloudfoundry/bosh-bootloader/azure"
	...
	"github.com/orange-cloudfoundry/bosh-bootloader/cloudconfig"
	...
	"github.com/orange-cloudfoundry/bosh-bootloader/runtimeconfig"
	"github.com/orange-cloudfoundry/bosh-bootloader/ssh"
	"github.com/orange-cloudfoundry/bosh-bootloader/storage"
	"github.com/orange-cloudfoundry/bosh-bootloader/terraform"
	"github.com/spf13/afero"

	awscloudconfig "github.com/orange-cloudfoundry/bosh-bootloader/cloudconfig/aws"
	azurecloudconfig "github.com/orange-cloudfoundry/bosh-bootloader/cloudconfig/azure"
	cloudstackcloudconfig "github.com/orange-cloudfoundry/bosh-bootloader/cloudconfig/cloudstack"
	gcpcloudconfig "github.com/orange-cloudfoundry/bosh-bootloader/cloudconfig/gcp"
	openstackcloudconfig "github.com/orange-cloudfoundry/bosh-bootloader/cloudconfig/openstack"
	vspherecloudconfig "github.com/orange-cloudfoundry/bosh-bootloader/cloudconfig/vsphere"

	awsterraform "github.com/orange-cloudfoundry/bosh-bootloader/terraform/aws"
	azureterraform "github.com/orange-cloudfoundry/bosh-bootloader/terraform/azure"
	cloudstackterraform "github.com/orange-cloudfoundry/bosh-bootloader/terraform/cloudstack"
	gcpterraform "github.com/orange-cloudfoundry/bosh-bootloader/terraform/gcp"
	openstackterraform "github.com/orange-cloudfoundry/bosh-bootloader/terraform/openstack"
	vsphereterraform "github.com/orange-cloudfoundry/bosh-bootloader/terraform/vsphere"
