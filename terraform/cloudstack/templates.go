...
func templatesBaseTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/base.tf", size: 7068, mode: os.FileMode(480), modTime: time.Unix(1542630218, 0)}
...
func templatesSec_groupTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/sec_group.tf", size: 6202, mode: os.FileMode(480), modTime: time.Unix(1542630745, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
