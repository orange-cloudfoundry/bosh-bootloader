...
output "internal_cidr" {
  value = var.vsphere_subnet_cidr
}

output "internal_gw" {
  value = var.internal_gw
}
...
output "director__internal_ip" {
  value = var.director_internal_ip
}
...
output "vcenter_disks" {
  value = var.vcenter_disks
}
